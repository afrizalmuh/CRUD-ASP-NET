...
namespace CRUD_APPLICATION.Controllers
{
    public class PeopleController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nik,Name,Alamat,StatusPerkawinan")] Person person)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nik,Name,Alamat,StatusPerkawinan")] Person person)
        {
            if (id != person.Id)
            {
                return NotFound();
